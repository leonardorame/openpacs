...
//griensu-Nico
#define RECORDIDX_BodyPartExamined               42
#define RECORDIDX_Rows                           43
#define RECORDIDX_Columns                        44
#define RECORDIDX_WindowCenter                   45
#define RECORDIDX_WindowWidth                    46
//griensu-Nico
...
struct IdxRecord
{
    ...
    char    WindowCenter                    [US_MAX_LENGTH+1] ;
    char    WindowWidth                     [US_MAX_LENGTH+1] ;
    //griensu-Nico
